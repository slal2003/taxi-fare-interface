// let taxiFareApiUrl = 'http://localhost:5001/predict'; // replace with your API endpoint
const centralCoordinates = [-74.00597, 40.71427];
const taxiFareApiUrl = 'https://taxifare.lewagon.ai/predict' // starting position [lng, lat]
